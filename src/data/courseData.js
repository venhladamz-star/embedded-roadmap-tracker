  ...
  'w1': {
    ...
    resources: [
      ...
      },
      {
        ...
        url: 'https://www.youtube.com/playlist?list=PL_c9BZzLwBRKKqOc9TJz1pP0ASrxLMp2Q',
        tag: 'required',
      },
      {
        ...
        url: 'https://www.sololearn.com/en/learn/courses/c-introduction',
        tag: 'recommended',
      },
    ],
    exercises: [
    ...
    resources: [
      {
        ...
        title: 'State Machines (Embedded Artistry)',
        source: 'embeddedartistry.com',
        desc: 'Tổng hợp kiến thức và khóa học video của Miro Samek',
        url: 'https://embeddedartistry.com/blog/2022/05/11/state-machines/',
        tag: 'required',
      },
      {
      ...
      },
      {
        ...
        url: 'https://www.embedded.com/the-problem-with-dynamic-memory-allocation/',
        tag: 'recommended',
      },
    ],
    exercises: [
